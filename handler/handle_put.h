...
void handle_put(void* threadfd, char* rcv_buf, char* theirip) {
	...
	/* Logging */
	log_access(ACCESS_LOG, theirip, "PUT", req, 400, content_size);
	log_error(ERROR_LOG, theirip, "PUT", req, 400, content_size);
